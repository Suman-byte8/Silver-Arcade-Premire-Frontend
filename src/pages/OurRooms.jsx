...
const rooms = [
  ...
  { name: "Executive Deluxe Room", description: "Perfect for two guests with modern amenities.", type: "double", image: "https://www.silverarcadepremier.com/images/room2.jpeg" },
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-6">
        <div className="flex items-center border border-gray-300 rounded-full px-4 py-2 w-full max-w-xl">
