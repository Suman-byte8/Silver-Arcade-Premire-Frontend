...
import { FaMapMarkerAlt, FaHistory, FaLeaf, FaWater, FaStar, FaArrowRight } from 'react-icons/fa';
  ...
  const features = [
    {
      ...
      description: "Discover Adina Mosque, Gour, and other heritage gems that tell the tales of Malda's glorious past.",
      image: "https://t4.ftcdn.net/jpg/00/44/62/05/360_F_44620573_DZvel9D2YSZMgEdDBaeo0nGjHSlxyy91.webp",
      highlights: ["Ancient Architecture", "Cultural Heritage", "Historical Significance"]
    },
    {
      icon: <FaLeaf className="text-4xl text-green-600" />,
      title: "Famous Mangoes",
      description: "Savor the sweetness of Malda's legendary mango varieties, a treat for every visitor.",
      image: "https://t4.ftcdn.net/jpg/02/21/24/05/240_F_221240514_f99S0HrrPieAMRUbgeRHYvcFRMsEeJOA.jpg",
      highlights: ["World-Famous", "Multiple Varieties", "Seasonal Delights"]
    },
    {
      icon: <FaWater className="text-4xl text-blue-600" />,
      title: "Serene Rivers",
      description: "Relax along the banks of the Mahananda River, soaking in the peaceful ambiance.",
      image: "https://www.shutterstock.com/image-photo/body-water-bridge-clouds-sky-260nw-2660151107.jpg",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50">
      ...
      <div className="relative h-96 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-yellow-600 to-orange-600" style={{ display: 'none' }} id="fallback-bg"></div>
        ...
        <div className="relative z-10 flex items-center justify-center h-full text-center text-white px-4">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl font-light mb-6 max-w-3xl mx-auto leading-relaxed">
              Where History Meets Hospitality, Culture Meets Cuisine, and Every Moment Creates Memories
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a href='https://malda.gov.in/history/' className="bg-white text-yellow-700 px-8 py-3 rounded-full font-semibold hover:bg-yellow-50 transition-all duration-300 transform hover:scale-105 shadow-lg" target='_blank' rel='noopener noreferrer'>
                Explore Heritage
              </a>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Nestled in the historic heart of West Bengal, Malda is a blend of cultural heritage, 
              lush landscapes, and warm hospitality. Explore the vibrant bazaars, taste the 
              world-famous mangoes, and step back in time with our ancient monuments.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-yellow-600 to-orange-600 rounded-2xl p-8 md:p-12 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/reservation" className="bg-white text-yellow-700 px-8 py-4 rounded-full font-semibold hover:bg-yellow-50 transition-all duration-300 transform hover:scale-105 shadow-lg">
                Book Your Stay
              </Link>
